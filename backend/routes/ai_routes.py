    ...
    def voice_command():
        try:
            ...
            if action == "scene_describe":
                ...
                if image_b64:
                    from ai_modules.ocr_engine import get_ocr_reader
                    ocr = get_ocr_reader().read_from_base64(image_b64) if hasattr(get_ocr_reader(), "read_from_base64") else get_ocr_reader().detect_from_base64(image_b64)
                    texts = ocr.get("texts", [])
                ...
                if image_b64:
                    try:
                        ...
                        if curr.get("detected"):
                            denom = curr.get("denomination", "unknown")
